...
def main():
    menu_options = {
        ...
        4: ("Find largest number",
            lambda: print(StringPerformance.largest(get_float_list_input("Enter numbers separated by spaces: ")))),
        5: ("Count frequency", lambda: print(
            StringPerformance.count_frequency(get_float_list_input("Enter numbers separated by spaces: ")))),
        ...
        8: (
        "Bubble sort", lambda: print(StringPerformance.bubble_sort(get_float_list_input("Enter numbers to sort: ")))),
        9: ("Find second largest", lambda: print(
            StringPerformance.find_second_largest(get_float_list_input("Enter numbers separated by spaces: ")))),
        10: ("Remove duplicates", lambda: print(
            StringPerformance.remove_duplicates(get_float_list_input("Enter numbers separated by spaces: ")))),
